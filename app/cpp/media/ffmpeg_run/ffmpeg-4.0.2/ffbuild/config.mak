...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-version3 --enable-nonfree --disable-static --enable-shared --enable-small --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-indev=v4l2 --enable-libx264 --disable-asm --prefix=/home/caiyu/shell_workspace/ffmepg_install/x86_64 --enable-cross-compile --target-os=android --arch=x86_64 --cross-prefix=x86_64-linux-android- --sysroot=/home/caiyu/shell_workspace/android-toolchain/x86_64/sysroot --extra-cflags='-march=core-avx-i -mtune=core-avx-i -m64 -mmmx -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mpopcnt -D__ANDROID__ -D__x86_64__ -I/home/caiyu/shell_workspace/x264_install/x86_64/include' --extra-ldflags=-L/home/caiyu/shell_workspace/x264_install/x86_64/lib
prefix=/home/caiyu/shell_workspace/ffmepg_install/x86_64
...
CC_IDENT=Android (5058415 based on r339409) clang version 8.0.2 (https://android.googlesource.com/toolchain/clang 40173bab62ec746213857d083c0e8b0abb568790) (https://android.googlesource.com/toolchain/llvm 7a6618d69e7e8111e1d49dc9e7813767c5ca756a) (based on LLVM 8.0.2svn)
ARCH=c
INTRINSICS=none
EXTERN_PREFIX=
CC=x86_64-linux-android-gcc
CXX=x86_64-linux-android-g++
AS=x86_64-linux-android-gcc
OBJCC=x86_64-linux-android-gcc
LD=x86_64-linux-android-gcc
DEPCC=x86_64-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=x86_64-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
ARFLAGS=rcD
AR_O=$@
AR_CMD=x86_64-linux-android-ar
NM_CMD=x86_64-linux-android-nm -g
RANLIB=x86_64-linux-android-ranlib -D
STRIP=x86_64-linux-android-strip
STRIPTYPE=direct
NVCC=nvcc
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/home/caiyu/shell_workspace/android-toolchain/x86_64/sysroot -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -march=core-avx-i -mtune=core-avx-i -m64 -mmmx -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mpopcnt -D__ANDROID__ -D__x86_64__ -I/home/caiyu/shell_workspace/x264_install/x86_64/include -std=c11 -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Oz -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -march=core-avx-i -mtune=core-avx-i -m64 -mmmx -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mpopcnt -D__ANDROID__ -D__x86_64__ -I/home/caiyu/shell_workspace/x264_install/x86_64/include -fPIC -g -Qunused-arguments
...
LD_PATH=-L
DLLTOOL=
WINDRES=x86_64-linux-android-windres
DEPWINDRES=x86_64-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/caiyu/shell_workspace/x264_install/x86_64/lib  --sysroot=/home/caiyu/shell_workspace/android-toolchain/x86_64/sysroot -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -lz -lx264 -pthread -lm
